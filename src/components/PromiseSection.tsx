    ...
    <section className="py-20 bg-gradient-to-b from-black to-emerald-900/20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-emerald-900/80 to-yellow-900/80 p-16 rounded-3xl border-4 border-emerald-500/50 mb-12 relative overflow-hidden">
            <div className="absolute inset-0">
              <img 
            ...
            <div className="relative z-10 text-center">
              <div className="flex justify-center mb-12">
                <div className="relative">
                  <DollarSign className="w-24 h-24 text-emerald-400 animate-pulse" />
              ...
              <div className="text-2xl md:text-3xl text-gray-300 leading-relaxed mb-12">
                Sabe qual é a diferença entre quem consegue e quem não consegue?<br />
                <span className="text-white font-black text-4xl">A primeira venda.</span><br />
                Quando você faz seus primeiros <span className="text-emerald-400 font-black text-5xl animate-pulse">R$100</span>...
              </div>
              
              <div className="text-4xl md:text-6xl font-black text-yellow-400 mb-12 animate-pulse drop-shadow-2xl">
                "PORRA... EU CONSIGO!"
              </div>
              
              <div className="text-xl md:text-2xl text-gray-300 leading-relaxed font-bold">
                É nesse momento que tudo muda...<br />
                Que você percebe que não é sorte...<br />
                <span className="text-emerald-400 font-black text-3xl">É método. É estratégia. É possível.</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative mb-16">
            <div className="bg-gradient-to-r from-black/90 to-emerald-900/50 p-16 rounded-3xl border-4 border-emerald-500/50 relative overflow-hidden">
              <div className="absolute inset-0">
                <img 
              ...
              <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-12">
                  ...
                  <div className="text-center group relative">
                    <div className="bg-gradient-to-b from-emerald-500/30 to-black/80 p-8 rounded-3xl border-4 border-emerald-500/50 hover:scale-105 transition-all duration-500 relative overflow-hidden">
                      <div className="absolute inset-0">
                        <img 
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="text-2xl font-black text-emerald-400 mb-4">DIA 1-3</div>
                        <div className="text-xl font-bold text-white mb-4">Você Aplica o Método</div>
                  ...
                  {/* Step 2 */}
                  <div className="text-center group relative">
                    <div className="bg-gradient-to-b from-yellow-500/30 to-black/80 p-8 rounded-3xl border-4 border-yellow-500/50 hover:scale-105 transition-all duration-500 relative overflow-hidden">
                      <div className="absolute inset-0">
                        <img 
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="text-2xl font-black text-yellow-400 mb-4">DIA 4-7</div>
                        <div className="text-xl font-bold text-white mb-4">A Primeira Grana Chega</div>
                        <div className="text-gray-300 font-bold">
                  ...
                  <div className="text-center group">
                    <div className="bg-gradient-to-b from-emerald-500/30 to-yellow-500/30 p-8 rounded-3xl border-4 border-emerald-500/50 hover:scale-105 transition-all duration-500 relative overflow-hidden">
                      <div className="absolute inset-0">
                        <img 
                      ...
                      <div className="relative z-10">
                        <div className="w-20 h-20 bg-gradient-to-r from-emerald-500 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
                          <TrendingUp className="w-10 h-10 text-white" />
                        </div>
                        <div className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-yellow-400 mb-4">DEPOIS</div>
                        <div className="text-xl font-bold text-white mb-4">Você Nunca Mais É o Mesmo</div>
                        <div className="text-gray-300 font-bold">
                ...
                <div className="text-center mt-16">
                  ...
                  <div className="text-2xl md:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-yellow-400 to-emerald-400 animate-pulse">
          ...
          <div className="text-center">
            <a 
              ...
              className="group relative inline-flex bg-gradient-to-r from-emerald-500 via-yellow-500 to-emerald-500 hover:from-emerald-600 hover:via-yellow-600 hover:to-emerald-600 text-black text-xl md:text-2xl font-black py-8 px-16 rounded-full transition-all duration-500 transform hover:scale-110 shadow-2xl hover:shadow-emerald-500/50 animate-pulse hover:animate-none"
            >
